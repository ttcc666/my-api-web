<template>
    <a-drawer :open="visible" @update:open="emit('update:visible', $event)" title="主题设置" placement="right" :width="360">
        <a-space direction="vertical" :size="32" style="width: 100%">
            <div class="setting-section">
                ...
                <div class="color-grid">
                    <div v-for="color in presetColors" :key="color" class="color-block"
                        :class="{ active: themeStore.primaryColor === color }" :style="{ backgroundColor: color }"
...
import { CheckOutlined, FormatPainterOutlined, LayoutOutlined, FontSizeOutlined } from '@ant-design/icons-vue'
import { useThemeStore } from '@/stores/theme'
import type { LayoutMode, FontSize } from '@/stores/theme'
